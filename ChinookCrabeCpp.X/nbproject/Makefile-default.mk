...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/ChinookCrabeCpp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=source/CommandFunctions.cpp source/DRV8711_Para.cpp source/Interrupts.cpp source/MotorPID.cpp source/Setup.cpp source/SkadiFunctions.cpp source/SourceTemplate.cpp source/StateFunctions.cpp source/StateMachine.cpp source/main.cpp

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/source/CommandFunctions.o ${OBJECTDIR}/source/DRV8711_Para.o ${OBJECTDIR}/source/Interrupts.o ${OBJECTDIR}/source/MotorPID.o ${OBJECTDIR}/source/Setup.o ${OBJECTDIR}/source/SkadiFunctions.o ${OBJECTDIR}/source/SourceTemplate.o ${OBJECTDIR}/source/StateFunctions.o ${OBJECTDIR}/source/StateMachine.o ${OBJECTDIR}/source/main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/source/CommandFunctions.o.d ${OBJECTDIR}/source/DRV8711_Para.o.d ${OBJECTDIR}/source/Interrupts.o.d ${OBJECTDIR}/source/MotorPID.o.d ${OBJECTDIR}/source/Setup.o.d ${OBJECTDIR}/source/SkadiFunctions.o.d ${OBJECTDIR}/source/SourceTemplate.o.d ${OBJECTDIR}/source/StateFunctions.o.d ${OBJECTDIR}/source/StateMachine.o.d ${OBJECTDIR}/source/main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/source/CommandFunctions.o ${OBJECTDIR}/source/DRV8711_Para.o ${OBJECTDIR}/source/Interrupts.o ${OBJECTDIR}/source/MotorPID.o ${OBJECTDIR}/source/Setup.o ${OBJECTDIR}/source/SkadiFunctions.o ${OBJECTDIR}/source/SourceTemplate.o ${OBJECTDIR}/source/StateFunctions.o ${OBJECTDIR}/source/StateMachine.o ${OBJECTDIR}/source/main.o

# Source Files
SOURCEFILES=source/CommandFunctions.cpp source/DRV8711_Para.cpp source/Interrupts.cpp source/MotorPID.cpp source/Setup.cpp source/SkadiFunctions.cpp source/SourceTemplate.cpp source/StateFunctions.cpp source/StateMachine.cpp source/main.cpp
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/ChinookCrabeCpp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/source/MotorPID.o: source/MotorPID.cpp  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/source" 
	@${RM} ${OBJECTDIR}/source/MotorPID.o.d 
	@${RM} ${OBJECTDIR}/source/MotorPID.o 
	@${FIXDEPS} "${OBJECTDIR}/source/MotorPID.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CPPC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -fframe-base-loclist  -x c++ -c -mprocessor=$(MP_PROCESSOR_OPTION)  -frtti -fexceptions -fno-check-new -fenforce-eh-specs -MMD -MF "${OBJECTDIR}/source/MotorPID.o.d" -o ${OBJECTDIR}/source/MotorPID.o source/MotorPID.cpp   -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/source/MotorPID.o: source/MotorPID.cpp  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/source/MotorPID.o.d 
	@${RM} ${OBJECTDIR}/source/MotorPID.o 
	@${FIXDEPS} "${OBJECTDIR}/source/MotorPID.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CPPC} $(MP_EXTRA_CC_PRE)  -g -x c++ -c -mprocessor=$(MP_PROCESSOR_OPTION)  -frtti -fexceptions -fno-check-new -fenforce-eh-specs -MMD -MF "${OBJECTDIR}/source/MotorPID.o.d" -o ${OBJECTDIR}/source/MotorPID.o source/MotorPID.cpp   -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/ChinookCrabeCpp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ChinookLib/ChinookLib.X/dist/default/debug/ChinookLib.X.a  
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CPPC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/ChinookCrabeCpp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    ChinookLib\ChinookLib.X\dist\default\debug\ChinookLib.X.a      -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD)    -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC024FF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/ChinookCrabeCpp.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ChinookLib/ChinookLib.X/dist/default/production/ChinookLib.X.a 
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CPPC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/ChinookCrabeCpp.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    ChinookLib\ChinookLib.X\dist\default\production\ChinookLib.X.a      -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/ChinookCrabeCpp.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
